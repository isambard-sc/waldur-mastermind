...
from waldur_openportal.tests import fixtures as openportal_fixtures


class AllocationCreateTest(test.APITransactionTestCase):
    def setUp(self):
        fixture = openportal_fixtures.OpenPortalFixture()
    ...
    def test_create_allocation_if_order_is_approved(self):
        ...
        self.assertTrue(
            openportal_models.Allocation.objects.filter(
...
class AllocationDeleteTest(test.APITransactionTestCase):
    def setUp(self):
        self.fixture = openportal_fixtures.OpenPortalFixture()
    ...
    def test_deletion_is_scheduled(self):
        ...
        self.assertEqual(
            self.allocation.state, openportal_models.Allocation.States.DELETION_SCHEDULED
        )

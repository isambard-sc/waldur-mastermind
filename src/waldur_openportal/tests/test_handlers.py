...
class OpenPortalAssociationSynchronizationTest(TransactionTestCase):
    def setUp(self):
    ...
    def test_when_customer_owner_role_is_granted_profile_is_synchronized(self):
        with mock.patch("waldur_openportal.tasks.process_role_granted") as mock_task:
    ...
    def test_when_customer_owner_role_is_revoked_profile_is_synchronized(self):
        self.customer.add_user(self.user, CustomerRole.OWNER)
        with mock.patch("waldur_openportal.tasks.process_role_revoked") as mock_task:
    ...
    def test_customer_association_is_created_if_it_does_not_exist_yet(self):
        ...
        with mock.patch("waldur_openportal.backend.OpenPortalClient") as mock_client:
